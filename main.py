...
BOT_TOKEN = "7099743273:AAGRCMaWjE2YN56lCjworwq7xV1LPK2JuT8"
PAYMENT_CHANNEL = "@payment_71" #add payment channel here including the '@' sign
OWNER_ID = 6767112534 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@freecasinobonus1"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
